...
// // Define interface for adding year data
// interface IAddYearData {
//   year: number;
//   courseId: string;
// }

// // Controller for adding a year to a course
// // Controller for adding a year to a course
// export const addYearToCourse = CatchAsyncError(
//   async (req: Request, res: Response, next: NextFunction) => {
//     try {
//       const { year, courseId }: IAddYearData = req.body;
...
//       // Ensure the 'years' array exists. Initialize it if it doesn't.
//       if (!course.years) {
//         course.years = [];
//       }
